...
/*                margin:auto;
    ...
    <body>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-12">
                                <center><h2><b><u>Manage Bookings</u></b></h2></center>
                            </div>
                        </div>
                    </div>  
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <% int tcost = 0;
                                ...
                                ArrayList<bookings> ar = s1.getcartinfo();
        ...
        <div class="bookmore">
            <a href="booknow.jsp"><button type="button" class="btn btn-warning"> Book More </button></a>
        </div>

        <div class="cfnbooking">
            <a href="userbookings.jsp"><button type="button" class="btn btn-warning" onclick="cnf()"> Confirm Booking </button></a>
        </div>
        
        <div class="goback">
            <a href="ind.jsp"><button type="button" class="btn btn-warning" onclick="cnf()"> Go Back </button></a>
        </div>
