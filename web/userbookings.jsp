...
<html>
    ...
    <body>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-12">
                                <center><h2><b><u>Booked Rooms</u></b></h2></center>
                            </div>
                        </div>
                    </div>  
        ...
        <div class="mainpage">
            <a href="ind.jsp"><button type="button" class="btn btn-warning"> Main Page </button></a>
        </div>
